...
# Updated and moved for V11!

The V11 system finally got made, and I finally bundled in the dice roller!
The new system is COMPLETELY incompatible with the one you're looking at right now so bear that in mind. In fact it was so different I moved the whole project to a new repository. You can find the new system here:
https://gitlab.com/foundry-mods/Deadlands-Classic/-/releases
